...
class DataConfig:
    ...
    # (enpei) Local dataset root directory. If set, the LeRobot dataset is loaded from this
    # local path instead of being downloaded from the HuggingFace hub.
    root: str | None = None
...
class DataConfigFactory(abc.ABC):
    ...
    # (enpei) Local dataset root directory, passed through to DataConfig. If set, the dataset is
    # loaded from this local path instead of the HuggingFace hub.
    root: str | None = None
...
_CONFIGS = [
    ...
    #
    # (enpei) pi0.5 单臂 LoRA 低显存微调 —— 基于官方 pi05_libero,改为 enpei 数据集 + 本地 pi05_base 权重。
